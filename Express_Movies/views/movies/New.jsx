      ...
      <DefaultLayout>
        ...
        <form action="/movies" method="post">
          <fieldset>
            ...
            <label>
              TITLE:
              <input type="text" name="title" placeholder="enter movie" />
            </label>

            <label>
              RELEASE DATE:
              <input type="text" name="releaseDate" placeholder="enter year" />
            </label>
            ...
            <label>
              ...
              <input type="text" name="cast" placeholder="enter stars" />
            </label>
